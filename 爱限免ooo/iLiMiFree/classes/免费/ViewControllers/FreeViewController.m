...
#import "TimeFree.h"
#import "CustomFreeCell.h"
#import "SetViewController.h"
@interface FreeViewController ()<UITableViewDataSource,UITableViewDelegate,MJRefreshBaseViewDelegate>
...
-(void)loadDataFromNet
{
    ...
    [[HttpRequestManager shareInstance]getLimitInfoByPage:_currentPage tag:12 success:^(id responseObj) {
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
   ...
   CustomFreeCell*cell=[tableView dequeueReusableCellWithIdentifier:@"CustomFreeCell"];
    ...
    cell.starsimgView.frame=CGRectMake(124, 78, 20*[cell.starsLabel.text floatValue], 30);
